...
public enum MyString {
	...
	CONNECTED_START		("&aConnection established"),
	CONNECTED_END		("&aConnection ended"),
	...
	UNLOCK_Question		("&aAre you &e-member- &a? &etype &fyes&e/&fno"),
	UNLOCK_HELP			("&7/tigerbot unlock [server] [name]"),	
	
	QUESTION_TIMEOUT	("&cit is too late."),
	QUESTION_RESET		("&cServer is restarting. All Questions are terminated"),
